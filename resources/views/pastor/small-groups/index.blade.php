<x-sidebar-layout title="Life Groups Management">
    ...
    <script>
        ...
        async function loadAvailableLeaders() {
            try {
                console.log('Loading available leaders...');
                ...
                console.log('Making leaders API call...');
                ...
                console.log('Leaders API response status:', response.status);
                console.log('Leaders API response ok:', response.ok);

                if (response.ok) {
                    const data = await response.json();
                    console.log('Leaders API response data:', data);
                    ...
                    if (leaderSelect && data.data) {
                        console.log('Setting up leader options, count:', data.data.length);
                        ...
                        console.log('Leader dropdown populated successfully');
                    } else {
                        console.error('Invalid response format or missing leader select element');
                        console.error('Data structure:', data);
                        console.error('Leader select element:', leaderSelect);
                        if (leaderSelect) {
                            leaderSelect.innerHTML = '<option value="">No Leader Assigned</option>';
                        }
                    }
