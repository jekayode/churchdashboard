<x-sidebar-layout title="Members Management">
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex space-x-3">
            <a href="{{ route('admin.import-export') }}" class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg">
                Import Members
            </a>
    ...
    <script>
        ...
        let currentFilters = {};
        let branches = [];
        const isSuperAdmin = true; // Admin members page is always super admin
