<x-sidebar-layout title="Mass Communication">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <button @click="showFilters = !showFilters" 
                    ...
                    <svg class="ml-2 w-4 h-4 transition-transform" :class="{'rotate-180': showFilters}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8" x-show="showFilters">
                <!-- Message Settings -->
                <div>
                    <div class="space-y-4">
                        <div>
        ...
        <div class="bg-white rounded-lg shadow-sm p-6" x-show="recipients.length > 0">
            ...
            <div class="max-h-64 overflow-y-auto">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2">
                    <template x-for="(recipient, index) in recipients" :key="'recipient-' + recipient.id + '-' + recipient.type + '-' + index">
            ...
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div x-show="preview" class="space-y-4">
                        <div x-show="preview && preview.subject">
                        ...
                        <div>
                            ...
                            <div class="mt-1 text-sm text-gray-600" x-text="(preview?.recipient_count || 0) + ' recipients'"></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        document.addEventListener('alpine:init', () => {
            console.log('Registering massCommunication component...');
            Alpine.data('massCommunication', () => ({
                branches: [],
                templates: [],
                availableFilters: {},
                recipients: [],
                ...
                async loadFilters() {
                    ...
                    try {
                        ...
                        const data = await response.json();
                        this.availableFilters = data.data?.filters || data.filters || {};
                    } catch (error) {
                ...
                async loadRecipients() {
                    ...
                    try {
                        ...
                        const data = await response.json();
                        console.log('Mass Send API Response:', data);
                        this.recipients = data.data?.recipients || data.recipients || [];
                        console.log('Mass Send Recipients:', this.recipients);
                    } catch (error) {
                ...
                async previewMessage() {
                    ...
                    try {
                        ...
                        const data = await response.json();
                        this.preview = data.data?.preview || data.preview;
                ...
                async sendMessage() {
                    ...
                    try {
                        ...
                        const data = await response.json();
                        this.sendResults = data.data?.summary || data.summary || data.results || data;
